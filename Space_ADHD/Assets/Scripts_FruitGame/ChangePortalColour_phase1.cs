...
public class ChangePortalColour_phase1 : MonoBehaviour
{
    ...
    //         fruitImage.GetComponent<Image>().color = ListColour[index];
    //
    //     }
    //
    //     void CustomPalette()
    //     {
    //         ListColour.Add(new Color((LoadFruits.myFruitList.fruit[1].R) / 255,
    //             (LoadFruits.myFruitList.fruit[1].G) / 255,
    //             (LoadFruits.myFruitList.fruit[1].B) / 255, 0.5f));
    //         ListColour.Add(new Color((LoadFruits.myFruitList.fruit[0].R) / 255,
    //             (LoadFruits.myFruitList.fruit[0].G) / 255,
    //             (LoadFruits.myFruitList.fruit[0].B) / 255, 0.5f));
    //         ListColour.Add(new Color((LoadFruits.myFruitList.fruit[3].R) / 255,
    //             (LoadFruits.myFruitList.fruit[3].G) / 255,
    //             (LoadFruits.myFruitList.fruit[3].B) / 255, 0.5f));
    //         ListColour.Add(new Color((LoadFruits.myFruitList.fruit[5].R) / 255,
